  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ marginTop: '40px', color: '#141414', fontFamily: "var(--font-display, 'Outfit', sans-serif)", fontWeight: 600 }}>2. Information We Collect</h2>
        <p>We may collect information about you in a variety of ways. The information we may collect includes:</p>
        <ul style={{ paddingLeft: '20px' }}>
            <li style={{ marginBottom: '10px' }}><strong style={{ color: '#141414' }}>Personal Data:</strong> Personally identifiable information, such as your name, email address, and profile picture, that you voluntarily give to us when you register with the application via OAuth providers.</li>
            <li style={{ marginBottom: '10px' }}><strong style={{ color: '#141414' }}>Application Data:</strong> Data related to your use of the application, including meeting metadata, calendar events, and project details submitted through our platform.</li>
        </ul>

        <h2 style={{ marginTop: '40px', color: '#141414', fontFamily: "var(--font-display, 'Outfit', sans-serif)", fontWeight: 600 }}>3. Google Data and API Services User Data Policy</h2>
        <p>Leddger AI utilizes Google OAuth for authentication and requests access to specific user data (such as Google Calendar events) to provide its core functionality. Our use of information received from Google APIs will adhere to the <a href="https://developers.google.com/terms/api-services-user-data-policy" target="_blank" rel="noreferrer" style={{ color: '#141414', textDecoration: 'none', fontWeight: 600 }}>Google API Services User Data Policy</a>, including the Limited Use requirements.</p>
        
        <h3 style={{ marginTop: '20px', color: '#141414', fontWeight: 600 }}>How Google Data is Accessed and Used</h3>
        ...
        <h3 style={{ marginTop: '20px', color: '#141414', fontWeight: 600 }}>How Google Data is Stored</h3>
        ...
        <h3 style={{ marginTop: '20px', color: '#141414', fontWeight: 600 }}>How Google Data is Shared</h3>
        <p><strong style={{ color: '#141414' }}>We do not sell, trade, or otherwise transfer your Google user data to outside parties.</strong> Your data is not used for advertising purposes. We only share data with trusted third-party service providers (such as secure cloud hosting platforms) who assist us in operating our application, conducting our business, or servicing you, so long as those parties agree to keep this information confidential and comply with strict data protection standards.</p>

        <h2 style={{ marginTop: '40px', color: '#141414', fontFamily: "var(--font-display, 'Outfit', sans-serif)", fontWeight: 600 }}>4. Use of Your Information</h2>
        ...
        <h2 style={{ marginTop: '40px', color: '#141414', fontFamily: "var(--font-display, 'Outfit', sans-serif)", fontWeight: 600 }}>5. Data Security</h2>
        <p>We use administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that despite our efforts, no security measures are perfect or impenetrable.</p>

        <h2 style={{ marginTop: '40px', color: '#141414', fontFamily: "var(--font-display, 'Outfit', sans-serif)", fontWeight: 600 }}>6. Contact Us</h2>
