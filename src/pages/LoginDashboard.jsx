...
export default function LoginDashboard({ onGoogleLogin, onEmailLogin, loading }) {
    ...
    <div className="login-page">
      ...
      <div className="login-container">
        <div className="login-logo">
          <img src="/logo.webp" alt="Leddger Logo" style={{ width: '96px', height: '96px' }} />
        </div>
        
        <p className="login-subtitle">Sign in to Leddger AI to access your recruitment dashboard.</p>
        ...
        <div className="login-buttons">
          ...
          <button 
            type="button"
            className="login-btn login-btn-linkedin"
            onClick={onGoogleLogin}
            disabled={loading}
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
